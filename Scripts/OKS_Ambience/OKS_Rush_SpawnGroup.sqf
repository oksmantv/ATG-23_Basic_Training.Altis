/*
	...
	[SpawnPos,UnitsPerBase,Side,Range] execVM "Scripts\OKS_Ambience\OKS_Rush_SpawnGroup.sqf";
*/
	...
	for "_i" from 1 to (_NumberInfantry) do
	{
		...
		{
			_Unit = _Group CreateUnit [(_Leaders call BIS_FNC_selectRandom), _SpawnPos, [], 0, "CAN_COLLIDE"];
			_Unit setRank "SERGEANT";
		} else {
			_Unit = _Group CreateUnit [(_Units call BIS_FNC_selectRandom), _SpawnPos, [], 0, "CAN_COLLIDE"];
			_Unit setRank "PRIVATE";
			
		};
		[_Unit,"FSM"] remoteExec ["disableAI",0];
		[_Unit,false] remoteExec ["enableAttack",0];
		sleep 0.5;
	};
